...
def main():
    ...
    trainer.get_train_loader("../data/ModelNet40-12-split/train", batch_size=32, shuffle=True, num_workers=8)
    trainer.get_test_loader("../data/ModelNet40-12-split/test", batch_size=32, shuffle=False, num_workers=8)
    
    num_epochs = int(input("Enter number of epochs to train: ") or "50")
